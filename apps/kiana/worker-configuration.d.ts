/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c5ae0560550f22585d430568fcb99350)
...
interface __BaseEnv_Env {
	...
	WOODEN_FISH: DurableObjectNamespace<import("./src/server").WoodenFish>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatRoom" | "WoodenFish";
	}
