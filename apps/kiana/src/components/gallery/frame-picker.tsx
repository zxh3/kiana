      ...
      >
        {frames.map((option, index) => (
          <button
            ...
            className={cx(
              "min-w-[104px] cursor-pointer rounded-full border-0 bg-transparent px-4 py-[9px] text-[9px] leading-none font-normal tracking-[.22em] text-[rgba(246,240,230,.58)] uppercase indent-[.22em] outline-none transition-[color,background-color] duration-200 hover:text-[#f6f0e6] focus-visible:text-[#f6f0e6] focus-visible:shadow-[inset_0_0_0_1px_rgba(246,240,230,.65)] max-sm:min-h-10.5 max-sm:min-w-[86px] max-sm:px-2.5 max-sm:py-0 max-sm:text-[8px] max-sm:tracking-[.16em] max-sm:indent-[.16em]",
